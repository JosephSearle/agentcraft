...
async_remote: AsyncSubAgent = {
    ...
    "url": "https://my-coder-service.your-langgraph-server.example.com",
}
```

Valid Agent Protocol targets:
- LangGraph Platform deployments (managed LangGraph Server)
...
- **LangGraph Platform deployments:** Set `LANGGRAPH_API_KEY` environment variable; the SDK includes it automatically.
