...
| [references/integration.md](references/integration.md) | Integration with llm-evaluation and observability skills, multi-model grading, MLflow trace inspection | Integration with evaluation/observability infrastructure |
