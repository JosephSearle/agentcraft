...
description: >
  ...
  Daytona, Runloop, AgentCore), sandbox lifecycle and scoping, integration
  patterns, and the secrets security model. Triggers on: sandbox, ModalSandbox, DaytonaSandbox,
  RunloopSandbox, AgentCoreSandbox, BaseSandbox, SandboxBackendProtocol,
...
|---|---|---|
| Which provider to use, Modal/Daytona/Runloop/AgentCore, install/setup | Provider setup | `references/providers.md` |
...
|---|---|---|
| `references/providers.md` | All four providers, BaseSandbox, SandboxBackendProtocol, execute() contract | Provider selection or setup |
